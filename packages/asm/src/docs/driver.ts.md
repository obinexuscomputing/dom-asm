```typescript
import { StateMachine } from '../automaton/StateMachine';
import { StateMinimizer, Automaton } from '../automaton/StateMinimizer';
import { StateMachineAST, StateMachineASTOptimizer, ASTNode } from '../automaton/StateMachineAST';
import { StateMachineValidator } from '../automaton/StateMachineValidator';
